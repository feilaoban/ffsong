...
public class PhysiqueJudge {
    ...
    public static void main(String[] args) {
        ...
        EntryScore yangXuScore2 = new EntryScore(2, false);
        EntryScore yangXuScore3 = new EntryScore(1, false);
        EntryScore yangXuScore4 = new EntryScore(2, false);
        EntryScore yangXuScore5 = new EntryScore(1, false);
        EntryScore yangXuScore6 = new EntryScore(1, false);
        EntryScore yangXuScore7 = new EntryScore(3, false);
        ...
        physique.add(yangXu);
        // 阴虚质
        EntryScore yinXuScore1 = new EntryScore(1, false);
        EntryScore yinXuScore2 = new EntryScore(2, false);
        EntryScore yinXuScore3 = new EntryScore(1, false);
        EntryScore yinXuScore4 = new EntryScore(2, false);
        EntryScore yinXuScore5 = new EntryScore(1, false);
        EntryScore yinXuScore6 = new EntryScore(1, false);
        EntryScore yinXuScore7 = new EntryScore(3, false);
        EntryScore yinXuScore8 = new EntryScore(2, false);
        ...
        physique.add(yinXu);
        // 气虚质
        EntryScore qiXuScore1 = new EntryScore(1, false);
        EntryScore qiXuScore2 = new EntryScore(2, false);
        EntryScore qiXuScore3 = new EntryScore(1, false);
        EntryScore qiXuScore4 = new EntryScore(2, false);
        EntryScore qiXuScore5 = new EntryScore(1, false);
        EntryScore qiXuScore6 = new EntryScore(1, false);
        EntryScore qiXuScore7 = new EntryScore(3, false);
        EntryScore qiXuScore8 = new EntryScore(1, false);
        ...
        EntryScore tanShiScore2 = new EntryScore(2, false);
        EntryScore tanShiScore3 = new EntryScore(2, false);
        EntryScore tanShiScore4 = new EntryScore(2, false);
        EntryScore tanShiScore5 = new EntryScore(3, false);
        ...
        EntryScore shiReScore2 = new EntryScore(2, false);
        EntryScore shiReScore3 = new EntryScore(2, false);
        EntryScore shiReScore4 = new EntryScore(2, false);
        EntryScore shiReScore5 = new EntryScore(3, false);
        EntryScore shiReScore6 = new EntryScore(1, false);
        EntryScore shiReScore7 = new EntryScore(1, false);
        ...
        physique.add(shiRe);
        // 血瘀质
        EntryScore xueYuScore1 = new EntryScore(2, false);
        EntryScore xueYuScore2 = new EntryScore(2, false);
        EntryScore xueYuScore3 = new EntryScore(2, false);
        EntryScore xueYuScore4 = new EntryScore(2, false);
        EntryScore xueYuScore5 = new EntryScore(3, false);
        EntryScore xueYuScore6 = new EntryScore(1, false);
        ...
        EntryScore teBingScore2 = new EntryScore(2, false);
        EntryScore teBingScore3 = new EntryScore(2, false);
        EntryScore teBingScore4 = new EntryScore(2, false);
        EntryScore teBingScore5 = new EntryScore(3, false);
        EntryScore teBingScore6 = new EntryScore(1, false);
        EntryScore teBingScore7 = new EntryScore(1, false);
        ...
        physique.add(teBing);
        // 气郁质
        EntryScore qiYuScore1 = new EntryScore(4, false);
        EntryScore qiYuScore2 = new EntryScore(4, false);
        EntryScore qiYuScore3 = new EntryScore(4, false);
        EntryScore qiYuScore4 = new EntryScore(4, false);
        EntryScore qiYuScore5 = new EntryScore(3, false);
        EntryScore qiYuScore6 = new EntryScore(1, false);
        ...
        physique.add(qiYu);
        // 平和质
        EntryScore pingHeScore1 = new EntryScore(5, false);
        EntryScore pingHeScore2 = new EntryScore(5, true);
        EntryScore pingHeScore3 = new EntryScore(2, true);
        EntryScore pingHeScore4 = new EntryScore(2, true);
        EntryScore pingHeScore5 = new EntryScore(1, true);
        EntryScore pingHeScore6 = new EntryScore(1, false);
        EntryScore pingHeScore7 = new EntryScore(1, true);
        EntryScore pingHeScore8 = new EntryScore(1, true);
